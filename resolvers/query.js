module.exports = {
  ...
  employerChats: async (_, { employeeId }, { services:{EmployerService}, user }) => {
  ...
  jobSeekerChats: async (_, { employerId }, { services:{JobSeekerService}, user }) => {
  ...
  jobSeekerMessages: async (_, __, { services:{JobSeekerService}, user }) => {
